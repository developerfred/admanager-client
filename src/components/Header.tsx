	...
	return (
		<header className="relative bg-black/50 backdrop-blur-md p-4 sm:p-6 border-b border-[#333]">
			<div className="max-w-7xl mx-auto flex justify-between items-center">
				<h1 className="text-3xl sm:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#D365E3] to-[#9AEDEF]">
					a+
				</h1>
				<nav className="hidden sm:flex space-x-4">
					...
					<Button
						variant="outline"
						className="border-[#D365E3] text-[#D365E3] hover:bg-[#D365E3] hover:text-black"
					>
						<ConnectButton />
					</Button>
				</nav>
			...
			{isMobileMenuOpen && (
				<div className="sm:hidden mt-4 space-y-2">
					...
					<Button
						variant="outline"
						className="w-full border-[#D365E3] text-[#D365E3] hover:bg-[#D365E3] hover:text-black"
					>
						Login
					</Button>
				</div>

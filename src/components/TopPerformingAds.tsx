...
const topAds: TopAd[] = [
	{
		id: 1,
		title: "Girl Power Merch",
		engagements: 15000,
		image: "https://via.placeholder.com/100",
	},
	{
		id: 2,
		title: "Retro Phone Cases",
		engagements: 12000,
		image: "https://via.placeholder.com/100",
	},
	{
		id: 3,
		title: "Neon Vibes Only",
		engagements: 10000,
		image: "https://via.placeholder.com/100",
	},
];
				...
				>
					<CardContent className="p-4">
						...
						<p className="text-sm text-[#D365E3] mb-2">
							{ad.engagements} engagements
						</p>
						<Button className="w-full bg-gradient-to-r from-[#D365E3] to-[#9AEDEF] text-black hover:opacity-90 transition-all duration-300">
